...
node -v  # Should print "v24.2.0" or your respective downloaded version.

# Verify npm version:
npm -v   # Should print "11.3.0" or your resepctive downloaded version.
```
### Install
...
```shell
cd mindfulmedia (\frontend or \backend)
```
